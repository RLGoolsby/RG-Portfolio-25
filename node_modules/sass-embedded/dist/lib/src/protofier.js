...
const module_1 = require("./value/module");
/**
...
class Protofier {
    ...
    protofy(value) {
        ...
        else if (value instanceof module_1.SassModule) {
            if (value.compileContext !== this.functions.compileContext) {
                throw utils.compilerError(`Value ${value} does not belong to this compilation`);
            }
            const module = (0, protobuf_1.create)(proto.Value_CompilerModuleSchema, value);
    ...
    deprotofy(value) {
        switch (value.value.case) {
            ...
            case 'compilerModule':
                return new module_1.SassModule(value.value.value.id, this.functions.compileContext);
            case 'calculation':
